...
export default function MyModal() {
  ...
  return (
    <div style={{width:"100%", height:"100vh",display:"flex", flexDirection:"column", justifyContent:"center",alignItems:"center" }}>  
        ...
        <Box sx={style2} style={{color:"rgb(149, 149, 149)",display:"flex",marginBottom:"0",justifyContent:"center",alignItems:"center"}}><div>Have an account? <span style={{color:"rgb(21, 101, 192)"}}>Log In</span></div></Box>
